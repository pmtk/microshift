...
def main():
    ...
    parser.add_argument("--create-pr", default=False, action="store_true",
        help="Commit the changes to a new branch, push it to the openshift/microshift, and create a pull request. Implies --update-file. Expects following env vars to be set: ORG, REPO, TOKEN or APP_ID and KEY")
