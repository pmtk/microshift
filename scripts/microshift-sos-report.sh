...
function usage() {
    ...
    echo "   --profiles PROFILES   Profiles to include in the report. Defaults to ${PROFILES}."
    echo "   --plugins PLUGINS     Plugins to include in the report. Defaults to ${PLUGINS}."
